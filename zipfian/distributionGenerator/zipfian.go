...
//
// Be aware: initializing this counter may take a long time if there are lots of items to choose from (e.g. over a
...
// NewZipfian creates the Zipfian counter.
