...
// Package fatcache provides a tdengine_client for the memcached cache server.
...
//	n, err = c.Increment("num", 1)
//	if err == nil || !strings.Contains(err.Error(), "tdengine_client error") {
//		t.Fatalf("increment non-number: want tdengine_client error, got %v", err)
//	}
